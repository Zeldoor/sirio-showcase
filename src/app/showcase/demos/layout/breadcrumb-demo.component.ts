...
export class BreadcrumbDemoComponent {
  ...
  <ngx-sirio-breadcrumb-item name="Home" href="/" [isActive]="true"></ngx-sirio-breadcrumb-item>
  <ngx-sirio-breadcrumb-item name="Componenti" href="/showcase" [isActive]="true"></ngx-sirio-breadcrumb-item>
  <ngx-sirio-breadcrumb-item name="Breadcrumb"></ngx-sirio-breadcrumb-item>
