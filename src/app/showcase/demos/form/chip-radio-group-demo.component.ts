...
export class ChipRadioGroupDemoComponent {
  ...
  <ngx-sirio-input-chip type="radio" label="Design" value="design">Design</ngx-sirio-input-chip>
  <ngx-sirio-input-chip type="radio" label="Sviluppo" value="sviluppo">Sviluppo</ngx-sirio-input-chip>
  <ngx-sirio-input-chip type="radio" label="Marketing" value="marketing">Marketing</ngx-sirio-input-chip>
