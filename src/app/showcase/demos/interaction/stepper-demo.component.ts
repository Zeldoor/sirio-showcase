  ...
  template: `<div class="component-demo">
    ...
    <div class="demo-tabs">
        ...
        <div class="demo-section">
          ...
          <div class="preview-area" style="width:100%">
            <ngx-sirio-stepper-progress-bar [hasDropdown]="false" style="display:block;width:100%">
              <ngx-sirio-stepper-progress-item label="Dati personali" status="success"></ngx-sirio-stepper-progress-item>
              <ngx-sirio-stepper-progress-item label="Indirizzo" status="active"></ngx-sirio-stepper-progress-item>
              <ngx-sirio-stepper-progress-item label="Pagamento" status="inactive"></ngx-sirio-stepper-progress-item>
      ...
      <div class="tab-content" *ngIf="activeTab==='api'">
        <h3>Inputs (StepperProgressItem)</h3>
        <table class="api-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><code>'active' | 'success' | 'inactive' | 'warning' | 'error'</code></td>
              <td>Stato dello step</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export class StepperDemoComponent {
  ...
  <ngx-sirio-stepper-progress-item label="Dati personali" status="success">
  </ngx-sirio-stepper-progress-item>
  <ngx-sirio-stepper-progress-item label="Indirizzo" status="active">
  </ngx-sirio-stepper-progress-item>
  <ngx-sirio-stepper-progress-item label="Pagamento" status="inactive">
  </ngx-sirio-stepper-progress-item>
